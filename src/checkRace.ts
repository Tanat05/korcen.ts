...
const sortedRACEProfanityPatterns = [...RACE_PROFANITY_PATTERNS];
sortedRACEProfanityPatterns.sort((a, b) => b.length - a.length);
...
export function race(text: string | any): boolean {
    ...
    for (const pattern of sortedRACEProfanityPatterns) {
