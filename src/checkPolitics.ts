...
const sortedPOLITICSProfanityPatterns = [...POLITICS_PROFANITY_PATTERNS];
sortedPOLITICSProfanityPatterns.sort((a, b) => b.length - a.length);
...
export function politics(text: string | any): boolean {
    ...
    for (const pattern of sortedPOLITICSProfanityPatterns) {
