...
const sortedPARENTProfanityPatterns = [...PARENT_PROFANITY_PATTERNS];
sortedPARENTProfanityPatterns.sort((a, b) => b.length - a.length);
...
export function check(text: string | any): boolean {
    ...
    for (const pattern of sortedPARENTProfanityPatterns) {
